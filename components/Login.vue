     ...
     <div class="container-fluid">
        ...
        <div class="row">
            <div class=" col-md-4 col-md-offset-4">
                <!-- Start Sign In Form -->
                <form action="#" class="fh-form  fadeIn " data-animate-effect="fadeIn">
                    <h2>Sign In</h2>
                    ...
                    <div class="form-group">
                        <p>Not registered? <router-link to="/reg">Sign Up</router-link> | <a href="#">Forgot
                                Password?</a></p>
                    </div>
                    <div class="form-group">
				              	<!-- <router-link to="#"> -->
                         <input type="button" value="Sign In"  class="btn btn-primary" @click="login">
                        <!-- </router-link> -->
                    </div>
                </form>
                <!-- END Sign In Form -->
        ...
        <div class="row text-end" >
            <div class="col-md-12 text-center">
                <p><small>&copy; 版权所有 <a href="#" target="_blank" >欢迎加入</a> <a href="#" title="" target="_blank">欢迎加入</a></small></p>
            </div>
        </div>
    </div>
    </div>
